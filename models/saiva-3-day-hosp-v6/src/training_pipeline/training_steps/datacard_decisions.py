...
CURRENT_STEP = TrainingStep.DATACARD_DECISIONS


def datacard_decisions(
    *,
    run_id: str,
    ...
    **kwargs
    ...
    """Generate the parameters for the datacard decisions.
    ...
    with open("/data/datacard_decisions_params.txt", "w") as f:
