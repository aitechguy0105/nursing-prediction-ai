...
def column_segregation(combined):
    ...
    ignore_cols = [col for col in combined.columns if 'target' in col] + ['masterpatientid', 'patientid',
                                                                          'censusdate', 'facilityid', 'bedid']
...
#     combined = add_na_indicators(combined, ignore_cols)
    ...
    drop_cols = ['patientid', 'beddescription', 'roomratetypedescription',
                 'payercode', 'carelevelcode', 'gender', 'dateofbirth', 'education',
