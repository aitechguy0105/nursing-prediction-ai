...
def get_embedding_models(emar_notes, progress_notes):
    """
...
def processing_word_vectors(final, emar_notes, progress_notes, clientClass):
    """
    ...
    embedding_models = get_embedding_models(emar_notes, progress_notes)
    ...
    if mean_na_count >= threshold_value:
        log_message(message_type='info', message=f'WARNING: {mean_na_count} is less than {threshold_value}')
