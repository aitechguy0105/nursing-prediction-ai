        ...
        *,
        ...
        return {
            ...
            'patient_admissions': f"""
                        select vob.patientid, vob.facilityid, vob.dateofadmission, '' as admissionstatus, 
                         '' as admittedfrom, '' as primaryphysicianid, vomp.primary_physician as primaryphysicianfirstname, '' as to_from_type 
        ...
        *,
        ...
        return {
            ...
            'patient_rehosps': f"""
                                 ...
                                 """,
            'patient_orders': f"""
                        select  patientid as masterpatientid, facilityid, order_category as ordercategory, order_type as ordertype,
