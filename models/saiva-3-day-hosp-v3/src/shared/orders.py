...
class OrderFeatures(BaseFeaturizer):
    ...
    def generate_features(self):
        ...
        base5 = self.drop_columns(
            base5,
            '_masterpatientid|_facilityid|orderdate|createddate|_x$|_y$|bedid|censusactioncode|payername|payercode'
        )
        ...
        assert base5.duplicated(subset=['masterpatientid', 'censusdate', 'facilityid']).any() == False
