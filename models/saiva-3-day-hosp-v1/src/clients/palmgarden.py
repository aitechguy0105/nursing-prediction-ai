...
class Palmgarden(BaseClient):
    ...
    def get_prediction_queries(self, prediction_date, facilityid, train_start_date):
        ...
        return {
            ...
            'patient_census': f"""
                        ...
                        and censusactioncode not in ('DAMA', 'DD', 'DE', 'DH', 'DL', 'HL', 'HP', 'HUP', 'LOA', 'RDD', 
                        'RDE', 'RDH', 'TL', 'TO', 'TOL', 'TP', 'TUP')
    ...
    def get_note_embeddings_emar_types(self):
        return ['eMAR - General Note from eRecord',
