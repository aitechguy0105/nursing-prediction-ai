"""
Run Command :
python /src/run_model.py --client avante --facilityids '[21]' --prediction_date 2021-04-28
...
class RunPredictions(BasePredictions):
    ...
    def execute(self):
        try:
            ...
            with start_task(action_type='run_model', client=self.client):
                # nlp_model is the same for all facilities in a given client
            ...
            # After for loop (i.e. all facilities have been predicted), we can cleanup the nlp model
    ...
    def run_model(
        ...
        log_message(
            ...
            cleanup_downloaded_models=cleanup_downloaded_models
        )
