...
class DbEngine(object):
    ...
    def get_secrets(self, secret_name):
        ...
        """
        log_message(message_type='info', dbengine_action='get_secrets', secret_name=secret_name)
        db_info = json.loads(
    ...
    def get_postgresdb_engine(self):
        ...
        """
        log_message(message_type='info', dbengine_action='connect_to_postgresdb', client='SaivaDB')
